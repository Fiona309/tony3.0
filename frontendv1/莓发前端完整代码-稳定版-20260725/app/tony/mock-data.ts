...
export const TARGET_META: Record<string, TargetMeta> = {
  ...
  pink: {
    alias: '粉色',
    accent: '#da7e9d',
    filter: 'hue-rotate(72deg) saturate(1.08) brightness(1.04)',
    riskName: '偏粉橘',
    color: {
      tone: 'pink',
      level: 8,
  ...
  cold_tea: {
    alias: '冷茶色',
    accent: '#74604e',
    filter: 'sepia(.32) saturate(.74) brightness(.86) contrast(1.06)',
    riskName: '偏暖棕',
    color: {
      tone: 'brown',
      level: 6,
  ...
  cold_brown: {
    alias: '冷棕色',
    accent: '#645246',
    filter: 'sepia(.26) saturate(.68) brightness(.82) contrast(1.08)',
    riskName: '偏暖棕',
    color: {
      tone: 'brown',
      level: 6,
...
export const MOCK_VIDEOS: MockVideo[] = [
  {
    ...
    url: '/mock-assets/blue/transition.mp4',
    cover_url: '/mock-assets/blue/after.jpg',
    target_frame_url: '/mock-assets/blue/after.jpg',
    trigger_time_ms: 1000,
    color_name: '蓝色',
    color_alias: '蓝色',
    accent: '#4169e1',
    bound_product_id: 'prod_blue_same',
    bound_tutorial_video_id: 'tutorial_blue',
  },
  {
    video_id: 'vid_red_transition',
    title: '红色颜值转场',
    video_type: 'dye_related',
    url: '/mock-assets/red/transition.mp4',
    cover_url: '/mock-assets/red/after.jpg',
    target_frame_url: '/mock-assets/red/after.jpg',
    trigger_time_ms: 5000,
    color_name: '红色',
    color_alias: '红色',
    accent: '#b0303e',
    bound_product_id: 'prod_red_same',
    bound_tutorial_video_id: 'tutorial_red',
  },
  {
    video_id: 'vid_purple_transition',
    title: '紫色颜值转场',
    video_type: 'dye_related',
    url: '/mock-assets/purple/transition.mp4',
    cover_url: '/mock-assets/purple/after.jpg',
    target_frame_url: '/mock-assets/purple/after.jpg',
    trigger_time_ms: 85000,
    color_name: '紫色',
    color_alias: '紫色',
    accent: '#704c9a',
    bound_product_id: 'prod_purple_same',
    bound_tutorial_video_id: 'tutorial_purple',
  },
  {
    video_id: 'vid_pink_tutorial',
    title: '粉色固色教程',
    video_type: 'dye_related',
    url: '/mock-assets/pink/tutorial.mp4',
    cover_url: '/mock-assets/pink/after.jpg',
    target_frame_url: '/mock-assets/pink/after.jpg',
    trigger_time_ms: 70000,
    color_name: '粉色',
    color_alias: '粉色',
    accent: '#da7e9d',
    bound_product_id: 'prod_pink_same',
    bound_tutorial_video_id: 'tutorial_pink',
  },
  {
    video_id: 'vid_cold_tea_tutorial',
    title: '冷茶短发教程',
    video_type: 'dye_related',
    url: '/mock-assets/cold_tea/tutorial.mp4',
    cover_url: '/mock-assets/cold_tea/after.jpg',
    target_frame_url: '/mock-assets/cold_tea/after.jpg',
    trigger_time_ms: 144000,
    color_name: '冷茶色',
    color_alias: '冷茶短发',
    accent: '#74604e',
    bound_product_id: 'prod_cold_tea_same',
    bound_tutorial_video_id: 'tutorial_cold_tea',
  },
  {
    video_id: 'vid_cold_brown_tutorial',
    title: '冷棕长发教程',
    video_type: 'dye_related',
    url: '/mock-assets/cold_brown/tutorial.mp4',
    cover_url: '/mock-assets/cold_brown/after.jpg',
    target_frame_url: '/mock-assets/cold_brown/after.jpg',
    trigger_time_ms: 134000,
    color_name: '冷棕色',
    color_alias: '冷棕长发',
    accent: '#645246',
    bound_product_id: 'prod_cold_brown_same',
    bound_tutorial_video_id: 'tutorial_cold_brown',
  },
];

const productImageFrames = [
  '/video-mock/frames/step-1-2.jpg',
  '/video-mock/frames/step-2-2.jpg',
  '/video-mock/frames/step-3-2.jpg',
  '/video-mock/frames/step-4-1.jpg',
  '/video-mock/frames/step-5-1.jpg',
...
function productImage(index: number) {
  return productImageFrames[index % productImageFrames.length];
}
...
export const TUTORIAL_VIDEO_META: Record<
  string,
  { title: string; color_name: string; brand: string; tutorial_type: string; url: string }
> = {
  tutorial_blue: {
    title: '蓝色卡洛美固色教程',
    color_name: '蓝色',
    brand: '卡洛美',
    tutorial_type: '染发/固色',
    url: '/mock-assets/blue/tutorial.mp4',
  },
  tutorial_red: {
    title: '红色染鲤染发教程',
    color_name: '红色',
    brand: '染鲤',
    tutorial_type: '染发',
    url: '/mock-assets/red/tutorial.mp4',
  },
  tutorial_purple: {
    title: '紫色卡洛美固色教程',
    color_name: '紫色',
    brand: '卡洛美',
    tutorial_type: '固色',
    url: '/mock-assets/purple/tutorial.mp4',
  },
  tutorial_pink: {
    title: '粉色 NV 固色教程',
    color_name: '粉色',
